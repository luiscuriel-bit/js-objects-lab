...
for (let i = 0, minHp = 90; i < pokemon.length; ++i) {
  if (pokemon[i].hp >= minHp) {
    game.party.push(pokemon[i]);
    if (game.party.length === 4) break;
  }
  else if (i === pokemon.length - 1 && game.party.length < 4) {
    minHp -= 10;
    i = 0;
  }
}
